...
svg_letters <-svg_letters[c(1:6),]
               
figure_1_layout <- figure_1_layout[c(1:10),]
        


# Figure_1.svg
# Inkscape_extenstions_example_start.svg

readLines("svg_top2.svg") |> 
  write_lines("Figure_1_panels/Inkscape_extenstions_example_start.svg")
...
for(i in 1:nrow(figure_1_layout)){
  ...
  write_lines(svg_code[g_code_lines$g_start[1]:g_code_lines$g_end[1]],"Figure_1_panels/Inkscape_extenstions_example_start.svg",append = T)
}
...
for(i in 1:nrow(svg_letters)){
  write_lines(svg_letters$svg_code[i],"Figure_1_panels/Inkscape_extenstions_example_start.svg",append = T)
}

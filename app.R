...
ui = dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Barplot2", tabName = "barplot2", icon = icon("dashboard")),
      menuItem("Counter", tabName = "Counter", icon = icon("dashboard")),
      menuItem("Batch Plot", tabName = "batch_plot", icon = icon("dashboard")),
  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "batch_plot",
              UI_batchplot("batchplot")
      ),
      ...
      #                      numericInput("paper_space_top", "Plot space top", 1.1)
      #                      )
      #                  ,
      # 
      #           fluidRow(
      ...
      #                 numericInput("poster_space_top", "Poster space top", 1.1)
      #                 )
      #             ))
      #           )
              )
...
server = function(input, output) {
  ...
  #                    space_top = input$paper_space_top,
  #                    legend_loc = "none")+
  ...
  #                     space_top = input$poster_space_top,
  #                     legend_loc = "none")+
